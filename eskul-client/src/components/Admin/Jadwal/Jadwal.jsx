...
const Ekstrakulikuler = () => {
  ...
  return (
    ...
    <div className="w-full flex flex-col gap-2">
      ...
      <h1 className="text-black text-2xl font-bold font-poppins capitalize opacity-60">Jadwal</h1>
   ...
   <div className='bg-light w-[600px] h-auto border shadow-md'>
     <div className='flex justify-between p-5 border-b border-gray-300  relative group'>
       <p className='font-semibold opacity-70'>Add Jadwal</p>
     ...
     <div className='w-full h-full'>
      <form action="" className='flex flex-col p-5 gap-2'>
        <label htmlFor="" className='text-xl'>Hari</label>
        ...
        <label htmlFor="" className='text-xl'>Ruangan</label>
        <input type="text" name="" id="" placeholder="Input Room" className='bg-transparent outline-none border p-3 rounded-md border-gray-400'/>
        <label htmlFor="" className='text-xl'>Waktu</label>
        <input type="time" name="" id="" placeholder="Input Room" className='bg-transparent outline-none border p-3 rounded-md border-gray-400'/>
