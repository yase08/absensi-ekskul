...
import { createActivityProgram, updateActivityProgram } from '../../../services/activityProgram.service';
...
const Ekstrakulikuler = () => {
  ...
  return (
    ...
    <div className="w-full flex flex-col gap-2">
      ...
      <h1 className="text-black text-2xl font-bold font-poppins capitalize opacity-60">Aktivitas Program</h1>
