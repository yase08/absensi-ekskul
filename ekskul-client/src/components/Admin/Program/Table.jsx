        ...
        <table className="min-w-full border-collapse w-full">
          <thead>
            <tr>
              ...
              <th className="px-6 py-3 white text-left">Nama Aktivitas</th>
              <th className="px-6 py-3 white text-left">Nama Tugas</th>
              <th className="px-6 py-3 white text-left">Tanggal Mulai</th>
              <th className="px-6 py-3 white text-left">Tanggal Berakhir</th>
