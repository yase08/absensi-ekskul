...
import { getAllAssessment } from '../../../services/asessment.service';

const TablePenilaian = ({ setFormOld, setOpen }) => {
  ...
  const handleGetRequest = async () => {
    try {
      const response = await getAllAssessment({ filter, sort, size, number});
      ...
      if (response && response.data) {
        ...
        if (Array.isArray(response.data.attendanceFilter)) {
          const responseData = response.data.attendanceFilter;
