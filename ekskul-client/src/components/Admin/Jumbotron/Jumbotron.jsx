...
const Jumbotron = ({ expanded }) => {
  ...
  return (
    <div className="w-full bg-transparent ">
      <div
        className={`bg-transition transition-all bg-transition duration-[700ms] relative bg-transparent text-white max-lg:h-[140px] lg:h-[150px] 2xl:h-[190px] max-md:h-[450px] flex justify-between items-start ${
