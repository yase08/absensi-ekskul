...
import { deleteActivityProgram, getAllActivityProgram } from '../../../services/activityProgram.service';
...
const TableEskul = ({ setFormOld, setOpen }) => {
  ...
  const handleGetRequest = async () => {
    try {
      const response = await getAllStudent({ filter, sort, size, number});
        ...
        <table className="min-w-full border-collapse w-full">
          <thead>
            ...
            <th className="w-1/6 flex items-center gap-1 px-6 py-3 white text-left text-base leading-4 text-gray-600 uppercase tracking-wider">
              ...
              <th className='px-6 py-3 white text-left'>NIS</th>
              <th className='px-6 py-3 white text-left'>Email</th>
              <th className='px-6 py-3 white text-left'>Number</th>
              <th className='px-6 py-3 white text-left'>Rombel</th>
              <th className='px-6 py-3 white text-left'>Rayon</th>
