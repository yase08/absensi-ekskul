                    ...
                    <div 
                        ...
                        {hovermanageDropdownVisible && (
                            <div className=' bg-white text-black w-[200px] rounded-md h-auto py-[20px]'>
                                ...
                                <Link to='/admin/manage/usermanagement' className={`py-[15px] flex gap-x-[24.5px] hover:text-primary items-center px-[20px] before:absolute `}>
                                    <p to="" className={`opacity-60 text-sm transition-opacity`}>Admin Management </p>
                                </Link>
                                <Link to='/admin/manage/adminmanagement' className={`flex gap-x-[24.5px] items-center hover:text-primary px-[20px] before:absolute py-[15px] `}>
                                    <p to="" className={`opacity-60 text-sm transition-opacity`}>User Management</p>
                                </Link>
                            </div>
                            )}
                   </div>
                ...
                <div className={`${expanded ? 'lg:hidden':''} ${hoverdataDropdownVisible ? '':''} `}>
                     {managementDropdownVisible && (
                        ...
                        onMouseLeave={handleDropdownMouseLeave}
                         className={`text-black mx-[45px] bg-transparent border-l-[1px] border-opacity-60 border-black before:w-20 before:h-20 before:bg-black   `}>
                             <div className={`flex flex-col bg-transparent `}>
                                <Link to='/admin/game/top-up' className={` py-[15px] flex gap-x-[24.5px] items-center before:absolute ${expanded ? 'items-center justify-center animate-fade-in-out' : 'px-[30px]'}`}>
                                    <IoDiamondSharp className={`opacity-60 `}/>
                                    <p to="" className={`opacity-60 text-sm ${expanded ? 'hidden' : ''} transition-opacity`}>Top Up</p>
                                </Link>
                                <Link to='/admin/game/joki' className={`flex gap-x-[24.5px] items-center before:absolute py-[15px] ${expanded ? 'items-center justify-center animate-fade-in-out' : 'px-[30px]'}`}>
                                    <BsJoystick className={`opacity-60`}/>
                                    <p to="" className={`opacity-60 text-sm ${expanded ? 'hidden' : ''} transition-opacity`}>Joki</p>
                                </Link>
                            </div>
                        </div>
                    )}
